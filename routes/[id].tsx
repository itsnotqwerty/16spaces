...
export default function Room({ params }: PageProps) {
  ...
  const isValidLobbyCode = /^[a-zA-Z0-9]{5}$/.test(id);
  if (!isValidLobbyCode) {
    return (
      <div class="p-4 mx-auto h-screen bg-[#161512] flex items-center justify-center">
        <h1 class="text-4xl text-white font-bold">Invalid Lobby Code</h1>
      </div>
    );
  }
  ...
  return (
    <div class="p-4 mx-auto h-screen bg-[#161512]">
      <script
        async
        src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2088911413615580"
